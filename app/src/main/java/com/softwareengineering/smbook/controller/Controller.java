...
public class Controller {
	...
	public static ArrayList<Hall> halls;
	public static ArrayList<Movie> movies;
	public static ArrayList<MovieScreening> screening;
	...
	public static ArrayList<Movie> searchMovie(Condition condition) {
		ArrayList<Movie> result = new ArrayList();
		if (movies != null) {
			if (condition.getMovieDirector() != null && condition.getMovieName() != null) {
				for (Movie mov : movies) {
					if (mov.getDirector().equals(condition.getMovieDirector())
							&& mov.getName().equals(condition.getMovieName())) {
						result.add(mov);
					}
				}
			} else if (condition.getMovieDirector() != null && condition.getMovieName() == null) {
				for (Movie mov : movies) {
					if (mov.getDirector().equals(condition.getMovieDirector())) {
						result.add(mov);
					}
				}
			} else if (condition.getMovieName() != null && condition.getMovieDirector() == null) {
				for (Movie mov : movies) {
					if (mov.getName().equals(condition.getMovieName())) {
						result.add(mov);
					}
					;
				}
			...
			Movie tempMovie = new Movie("tempTitle", "tempDirector");
